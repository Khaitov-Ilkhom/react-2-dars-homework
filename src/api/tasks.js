...
const taskTwo = [
    ...
    // !   The Lord of the Rings: The Rings of Power
    {
        ...
        description:
            "This epic drama is set thousands of years before the events of J.R.R. Tolkienâ€™s The Hobbit and The Lord of the Rings, and will take viewers back to an era in which great powers were forged, kingdoms rose to glory and fell to ruin, unlikely heroes were tested, hope hung by the finest of threads, and the greatest villain that ever flowed from Tolkienâ€™s pen threatened to cover all the world in darkness. Beginning in a time of relative peace, the series follows an ensemble cast of characters, both familiar and new, as they confront the long-feared re-emergence of evil to Middle-earth. From the darkest depths of the Misty Mountains, to the majestic forests of the elf-capital of Lindon, to the breathtaking island kingdom of NÃºmenor, to the furthest reaches of the map, these kingdoms and characters will carve out legacies that live on long after they are gone.",
        year: "2022",
        released: "2022",
        imdb: 7.0,
        genre: "#action, #adventure, #drama",
    ...
    // ! Loki
    {
        ...
        name: "Loki",
        description:
            "The mercurial villain Loki resumes his role as the God of Mischief in a new series that takes place after the events of â€œAvengers: Endgame.â€",
        year: "2021",
        released: "2021-2023",
        imdb: 8.2,
        genre: "#action, #adventure, #fantasy",
